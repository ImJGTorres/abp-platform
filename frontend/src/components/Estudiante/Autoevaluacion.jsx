...
export default function Autoevaluacion() {
    ...
    const [rubricaFijada,setRubricaFijada]= useState(false)  // true = bloqueada al id del docente
        ...
        try {
            ...
            if (puedeData.status === 'fulfilled') {
                ...
                if (!puede.puede) {
                    ...
                    // Fijar la rúbrica que usó el docente
            ...
            <div className="flex-1 flex items-center justify-center p-6" style={{ fontFamily: "'Manrope', sans-serif" }}>
                <div className="text-center max-w-sm">
                    ...
                    <p className="text-[13px] text-[#9ba7ae] leading-relaxed">
                        El docente debe aprobar y calificar al menos un entregable con rúbrica antes de que puedas autoevaluarte.
                    </p>
                </div>
            </div>
        )
