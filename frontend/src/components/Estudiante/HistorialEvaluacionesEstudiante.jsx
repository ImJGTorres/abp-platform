...
export default function HistorialEvaluacionesEstudiante() {
    ...
    async function cargar() {
        ...
        try {
            ...
            // 3. Para cada actividad, cargar entregables del estudiante (el backend filtra por equipo)
            ...
            // 5. Para aprobados con evaluaciones publicadas, cargar puntuación
            ...
            evalResults.forEach((evals, i) => {
                ...
                // Estudiante solo ve publicadas (backend lo filtra), tomar la más reciente
                const mejor = arr[0]
                if (mejor) {
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p className="text-[13px] text-[#9ba7ae] mt-0.5">
                        Historial de entregables revisados por el docente
                    </p>
                </div>
            </div>
                ...
                <div className="flex flex-col items-center justify-center gap-4 py-20 text-[#9ba7ae]">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-[13px]">
                            Aquí aparecerán los entregables revisados por el docente.
                        </p>
                    </div>
                </div>
            ) : (
