                ...
                <div className="w-full bg-white rounded-[28px] shadow-[0_12px_40px_rgba(25,28,29,0.08)]
                    ...
                    <div className="flex flex-col gap-7">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-[11px] font-semibold text-[#5b403d] tracking-[1px]">
                                O ACCEDA CON
                            </span>
                            <div className="flex-1 h-px bg-[#e1e3e4]" />
                        </div>
                        ...
                        <button
                            type="button"
                            className="w-full h-12 flex items-center justify-center gap-2 bg-[#f3f4f5] hover:bg-[#e8e9ea] rounded-xl
                        ...
                        >
                            ...
                            <svg className="w-4 h-4" viewBox="0 0 24 24">
                                <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"
                                    fill="#4285F4" />
                                <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 .06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"
                                    fill="#34A853" />
                            ...
                            <span className="text-[14px] font-semibold text-[#191c1d]">Google</span>
                        </button>
